                    ...
                    <table class="table table-bordered"
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <c:forEach var="el" items="${data.params}">
                                    <div id="dimensionform" class="group-box">
                                        <div name="group">
                                            <input type="text" value="${el.group}">
                                            <i class="click-expand glyphicon glyphicon-plus group-param-add"></i>
                                           <c:forEach var="_el" items="${el.params}">
                                               <div name="param">
                                                   <span>|-------</span>
                                                   <input type="text" value="${_el}">
...
<script type="text/javascript" src="/js/module/dimension/update.js"></script>